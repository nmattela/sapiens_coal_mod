init:
	x86_64-w64-mingw32-cmake -DMOD_ID=SapiensCoalMod -DMOD_NAME="Sapiens Coal Mod" -DDESCRIPTION="Adds coal and charcoal to the game: More efficient, long-lasting fuel types" -DDEVELOPER="nmattela" -DDEVELOPER_URL="https://mattelaer.dev" -DPREVIEW_FILE="preview.png" -DMOD_MAJOR_VERSION=0 -DMOD_MINOR_VERSION=1 -DMOD_PATCH_VERSION=0 . -B build
	cmake --build build/
